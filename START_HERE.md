...
- 全記事の収集・所在確認：完了
- 文脈解析あり：353件
- 個別カードあり：104件（詳細カード75件＋未解析カード29件）
- 詳細カードの改稿候補：74件
- 使用停止：1件
- 強度監査通過：0件
- 新しいB群再判定：停止
...
10. `analysis/stabilization_audit/MODELS_AND_INDEXES.md`
11. `analysis/stabilization_audit/BATCHES_AND_CROSS.md`
12. `analysis/stabilization_audit/OPERATIONS.md`
