...
- 全記事の収集・所在確認：完了
- 文脈解析あり：354件
- 個別カードあり：104件（詳細カード76件＋未解析カード28件）
- 詳細カードの改稿候補：74件
...
11. `analysis/stabilization_audit/MODELS_AND_INDEXES.md`
12. `analysis/stabilization_audit/BATCHES_AND_CROSS.md`
13. `analysis/stabilization_audit/OPERATIONS.md`
