...
| ファイル | 状態 | リスク | 疑う箇所 |
|---|---|---|---|
| `analysis/BATCH_02_RESPONSIBILITY_DECISION_EXIT.md` | HIGH-RISK | R2 R5 R12 | 異なる記事の権限差と怒りを、責任・決定・退出の一つの連鎖へ整える。 |
...
| ファイル | 状態 | リスク | 疑う箇所 |
|---|---|---|---|
| `analysis/PHASE_01_2026-01-24_TO_02-10.md` | HIGH-RISK | R6 R12 | 初期の飛躍・矛盾・制度案を、後期へ向かう形成史として並べ直す。 |
