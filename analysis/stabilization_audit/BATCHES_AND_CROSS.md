...
| `analysis/SECURITY_COMFORT_ROLE_ALLOCATION.md` | REWRITTEN-PENDING-USER | R2 R5 | 監査疑いを採用。国家・都市・家庭・市場の役割分担へ均し、負担押し付けの政治性を弱める危険があった。改稿では、Security / Comfort という補助線と、負担押し付け・最終処理場化・市場による階層化を分けるための仮配置へ戻した。 |
