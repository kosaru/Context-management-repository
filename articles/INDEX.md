...
- 個別カードあり：104件
- 個別カードなし：278件
- 詳細カード：77件（改稿候補74件＋使用停止1件＋新規・原文先行PENDING 2件）
- 未解析カード：27件
- 強度監査通過：0件

個別カードがあることは、元文章を正確に保持したことを意味しません。

詳細カード77件のうち、74件は改稿候補・ユーザー確認待ち、1件は使用停止、2件は新規・原文先行分析のPENDINGです。PASSEDは0件です。
...
12. [モデル監査](../analysis/stabilization_audit/MODELS_AND_INDEXES.md)
13. [バッチ・横断分析監査](../analysis/stabilization_audit/BATCHES_AND_CROSS.md)
14. [運用監査](../analysis/stabilization_audit/OPERATIONS.md)

## 探索用

- [全記事コンパクト地図](COMPACT_MAP.md)
- [自動生成された記事・解析索引](CARD_INDEX.md)
- [第1期地図](maps/PHASE_01.md)
- [第2期地図](maps/PHASE_02.md)
- [第3期地図](maps/PHASE_03.md)
- [第4期地図](maps/PHASE_04.md)
- [第5期地図](maps/PHASE_05.md)
- [第6期地図](maps/PHASE_06.md)
- [後期地図](maps/INDIVIDUAL_2026-05_TO_06.md)
...
旧テンプレートの使用を停止しました。新規作成と再監査には次を使います。

- [原文強度監査付き記事カード](../templates/article-card-strength-audit.md)
