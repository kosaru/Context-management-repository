...
- [x] 初回取得分25記事の本文スナップショットと記事カードを作成
- [x] 初回取得分25記事を解析
- [x] 初回取得分を対象に横断索引を作成
- [ ] note公開記事の全件数を確定
- [ ] 未取得記事を追加収集
...
解析済み：25記事 / 公開記事総数は未確定

> 注意：下表はnote全記事ではなく、初回取得できた25記事の一覧です。

## 記事カード一覧

この範囲は収集スクリプトが生成する。解析済みカードは収集スクリプトで上書きしない。
...
| 2026-06-12 | [「お前は悪くない」の先を語ってほしい―山田玲司へのエールとして](cards/2026-06-12-n310d6ea64e00.md) | analyzed | [公開本文](https://note.com/shirokuma1970/n/n310d6ea64e00) |
| 2026-06-12 | [「異常気象」という言葉で、何が消えているのか――二酸化炭素だけでは、気象も対策も読めない](cards/2026-06-12-ne080e4c70414.md) | analyzed | [公開本文](https://note.com/shirokuma1970/n/ne080e4c70414) |
